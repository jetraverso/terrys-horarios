...
- **Editar fichajes.** Solo los dueños con la casilla "edita fichajes" (Ajustes → Dueños; por defecto el primero). En la solapa Fichajes aparece "Editar" en cada fila y el botón "Agregar fichaje": se corrige entrada y salida, se agrega un fichaje que faltó o se borra uno equivocado. Las fotos se conservan, la fila queda marcada "editado" y todo va al registro de cambios con el antes y el después. Un dueño sin ese permiso tampoco puede pisar un fichaje desde la grilla ni cambiar la lista de dueños.
